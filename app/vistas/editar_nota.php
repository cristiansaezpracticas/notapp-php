...
.jqte_toolbar {
	...
	border-radius: 10px 10px 0px 0px !important;
        ...
        <form action="/editar_nota/<?= $nota->getId(); ?>" method="post" enctype="multipart/form-data">
            <input value="<?= $nota->getTitulo(); ?>" type="text" name="titulo" placeholder="Titulo">
            <textarea class="area" name="descripcion" id="descripcion" placeholder="Descripcion"><?= $nota->getDescripcion(); ?></textarea>
